...
|:------|:-----------|:--------|:---------------|
| 🟩 **Table 1** | Binary Classification | PCC% | ![Binary Results](fs-significance-studentdata/fs_significance/ikili.png)<br>_FS-based accuracy comparison_ |
| 🟨 **Table 2** | Five-Level Classification | PCC% | ![Five-Level Results](fs-significance-studentdata/fs_significance/five.png)<br>_5-level classification performance_ |
| 🟦 **Table 3** | Regression | RMSE ↓ | ![Regression Results](fs-significance-studentdata/fs_significance/reg.png)<br>_Lower RMSE indicates better model performance_ |
